    ...
    <div className="content content__wrap content__wrap--welcome">
      <div className="content__wrap__text row col-12">
        <div className="container text-center col-6">
          ...
          <h1>Hello.</h1>
          <h2>
            My name is Marek and im frontend developer from Czech republic.
          </h2>
          Feel free to contact me about work or help :)
          <br />
          <button className="btn btn-primary">Download resume</button>
        </div>
        <div className="container text-center col-6">
          <p>I love coding with:</p>
          <div className="featurimg row col-12">
            <div className="col-4">
              <img src={imgwp} />
            </div>
            <div className="col-4">
          ...
          <button className="btn btn-third">Contact me!</button>
        </div>
      </div>
    </div>
    <div className="content content__wrap content__wrap--skills">
        ...
        <div className="container text-center row">
          <div className="col-6">
            ...
            <div className="row content__wrap__progressbar text--secondary">
              ...
              <div className="progressbar">
                <span
                  className="progressbar--secondary"
                  style={{ width: '80%' }}
                />
              </div>
            </div>
            <div className="row content__wrap__progressbar text--third">
              <b>Javascript</b>
              <div className="progressbar">
                <span className="progressbar--third" style={{ width: '40%' }} />
              </div>
            </div>
          </div>
          <div className="col-6">
